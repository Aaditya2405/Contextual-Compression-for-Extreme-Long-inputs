...
✅ Our solution compresses with accountability. 🧠 Core Idea We use a hierarchical compression strategy: 
1.Clean the document 
2.Split it into overlapping chunks 
3.Compress each chunk independently 
4.Preserve traceability to the original chunk 
5.Enable question-answering on compressed data 
6.Report information loss transparently
